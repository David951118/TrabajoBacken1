<?php require_once('../../controllers/SeriesActorController.php'); ?>
<!DOCTYPE html>
<html lang="es">
<head>
    <meta charset="UTF-8">
    ...
    <div class="container pb-5">
        <div class="card shadow-sm">
            <div class="card-header bg-success text-white d-flex justify-content-between align-items-center">
                <h4 class="mb-0"><i class="fas fa-user-plus me-2"></i>Series - Reparto</h4>
                <a href="create.php" class="btn btn-light text-success btn-sm fw-bold"><i class="fas fa-plus me-1"></i>Asignar Actor</a>
            </div>
            <div class="card-body">
                <?php $list = listSeriesActors(); ?>
                <?php if (count($list) > 0) { ?>
                        ...
                        <table class="table table-hover align-middle">
                            ...
                            <tbody>
                                <?php foreach ($list as $item) { ?>
                                    <tr>
                                        <td><span class="badge bg-primary">Serie #<?php echo $item->getSeriesId(); ?></span></td>
                                        <td><span class="badge bg-warning text-dark">Actor #<?php echo $item->getActorId(); ?></span></td>
                                        <td class="text-end">
                                            <form action="delete.php" method="POST" style="display:inline" onsubmit="return confirm('¿Seguro que deseas eliminar esta relación?');">
                                                ...
                                                <input type="hidden" name="actor_id" value="<?php echo $item->getActorId(); ?>">
