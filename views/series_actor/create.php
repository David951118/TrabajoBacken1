...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!empty($series_id) && !empty($actor_id)) {
        ...
        else { $error = "Error al asignar el actor. Puede que ya esté asignado."; }
                            ...
                            <div class="mb-3">
                                ...
                                <select name="actor_id" class="form-select" required>
                                    ...
                                    <?php foreach ($actors as $actor): ?>
                                        <option value="<?php echo $actor->getId(); ?>"><?php echo htmlspecialchars($actor->getFirstName() . ' ' . $actor->getLastName()); ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
