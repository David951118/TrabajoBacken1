        ...
        <div class="container pb-5 mt-4">
            <div class="card shadow-sm">
                <div class="card-header bg-secondary text-white d-flex justify-content-between align-items-center">
                    ...
                    <a href="create.php" class="btn btn-light text-dark btn-sm fw-bold"><i
                            class="fas fa-plus me-1"></i>Nuevo Idioma</a>
                </div>
                <div class="card-body">
                                ...
                                <tbody>
                                    <?php foreach ($list as $item) { ?>
                                        <tr>
                                            ...
                                            <td><span
                                                    class="badge bg-dark"><?php echo htmlspecialchars($item->getIsoCode()); ?></span>
                                            </td>
                                            <td class="text-end">
                    ...
                    <?php } else { ?>
                        <div class="alert alert-info text-center"><i class="fas fa-info-circle me-2"></i>No hay idiomas
                            registrados.</div>
                    <?php } ?>
                </div>
            </div>
