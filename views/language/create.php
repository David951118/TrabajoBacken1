                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="create.php">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="name" name="name" placeholder="Ej: Español" required>
                            </div>
                            <div class="mb-4">
                                <label for="iso_code" class="form-label fw-bold">Código ISO</label>
                                <input type="text" class="form-control" id="iso_code" name="iso_code" placeholder="Ej: es" maxlength="2" required>
                            </div>
