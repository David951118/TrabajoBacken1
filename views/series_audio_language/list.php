                ...
                <div class="card shadow">
                    <div class="card-header bg-info text-white d-flex justify-content-between align-items-center">
                        ...
                        <a href="create.php" class="btn btn-light text-info btn-sm fw-bold"><i
                                class="fas fa-plus me-1"></i>Asignar Audio</a>
                    </div>
                    <div class="card-body">
                                ...
                                <table class="table table-hover align-middle">
                                    ...
                                    <tbody>
                                        <?php foreach ($list as $item) { ?>
                                            <tr>
                                                <td><span class="badge bg-success">Serie #
                                                        <?php echo $item->getSeriesId(); ?>
                                                    </span></td>
                                                <td><span class="badge bg-secondary">Idioma #
                                                        <?php echo $item->getLanguageId(); ?>
                                                    </span></td>
                                                <td class="text-end">
                        ...
                        <?php } else { ?>
                            <div class="alert alert-info text-center"><i class="fas fa-info-circle me-2"></i>No hay
                                asignaciones registradas.</div>
                        <?php } ?>
                    </div>
                </div>
            </div>
