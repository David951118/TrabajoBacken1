...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!empty($series_id) && !empty($language_id)) {
        $result = storeSeriesAudioLanguage($series_id, $language_id);
        if ($result) { header('Location: list.php'); exit(); }
        else { $error = "Error al asignar audio."; }
...
<head>
    ...
    <title>Asignar Audio - Dashboard</title>
            ...
            <div class="col-md-6">
                <div class="card shadow">
                    <div class="card-header bg-info text-white">
                        <h4 class="mb-0">Asignar Audio a Serie</h4>
                    </div>
                    <div class="card-body">
                        ...
                        <form method="POST" action="create.php">
                            ...
                            <div class="d-flex justify-content-end gap-2">
                                ...
                                <button type="submit" class="btn btn-info text-white">Asignar</button>
                            </div>
                        </form>
                    </div>
                </div>
